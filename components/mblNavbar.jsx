...
import { closeMblMenu, Loginfalse } from '../redux/counterSlice';
import { deleteItem, getItem } from '../utils/localStorage';
import { Metamask_comp_icon, Metamask_comp_text } from './metamask/Metamask';
...
const MblNavbar = ({ theme }) => {
  ...
  const pageTextData = [
    ...
    },
    {
      id: 17,
      text: "User",
      href: `/user/${getItem("userAddress")}`,
      New: false
    },
    {
      id: 18,
      text: "Edit Profile",
      href: `/profile/${getItem("userAddress")}`,
      New: false
    },
    {
      id: 19,
        ...
        {loggedin
          ? <div className="js-nav-dropdown group-dropdown relative">
              ...
              >
                ...
                <Link href={`/user/${getItem("userAddress")}`}>
                ...
                <Link href={`/profile/${getItem("userAddress")}`}>
                  <a className="dark:hover:bg-jacarta-600 hover:text-accent focus:text-accent hover:bg-jacarta-50 flex items-center space-x-2 rounded-xl px-5 py-2 transition-colors">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
