...
//       // console.log("...................................................",result)
//      await  axios
//           .put(process.env.NEXT_PUBLIC_SERVER_URL+`/Anft/auctionBid/${id}`,{address,bid:ETHAmount}).then(res=>console.log(data))
//           .catch((err) => console.log(err, "it has an error"));
...
//       {/*  <!-- Item --> */}
//      { item&&<BidsModal values={{id:item.id,modal,setModal,price:item.minbid,address,placeBid,loading}} />}
...
// const {id,modal,setModal,price,owner,placeBid,loading}=values
