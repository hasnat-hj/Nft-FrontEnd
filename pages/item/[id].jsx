...
const [loading, setLoading] = useState(false);
 ...
 setLoading(true)
    ...
    if (ETHAmount == null) {
      ...
      //  const result=   await fetch(process.env.NEXT_PUBLIC_SERVER_URL+`/Anft/auctionBid/${id}`, {
      //       method: "PUT",
      //       headers: {
      //         Accept: "application/json",
      //         "Content-Type": "application/json",
      //       },
      //       body: JSON.stringify({address,bid:ETHAmount}),
      //     });
      // console.log("...................................................",result)
    const result= await  axiosInstance
          .put(`/Anft/auctionBid/${id}`,{address,bid:ETHAmount})
...
//   const placeBid = async (ETHAmount) => {
//     const { auction, nft } = await loadContracts();
//     console.log("placing bid......")
...
//         // const bid = await auction.bid(nft.address, id, options); // replace 6 with token id nft token id
...
//     const result= await  axiosInstance
//           .put(`/Anft/auctionBid/${pid}`,{address,bid:ETHAmount})
//   console.log(result.data);
...
//       <Meta title={`${pid} || Blenny | NFT Marketplace Next.js Template`} />
//       {/*  <!-- Item --> */}
//      { item&&<BidsModal values={{id:item.id,modal,setModal,price:item.minbid,loading,placeBid}} />}
//      {item&& <section className="relative lg:mt-24 lg:pt-24 lg:pb-24 mt-24 pt-12 pb-24">
//         <picture className="pointer-events-none absolute inset-0 -z-10 dark:hidden">
//           <img
//             src="/images/gradient_light.jpg"
...
// const {id,modal,setModal,price,loading,placeBid}=values
